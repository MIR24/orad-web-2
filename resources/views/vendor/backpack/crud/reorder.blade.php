...
<link rel="stylesheet" href="{{ auto_asset('vendor/backpack/nestedSortable/nestedSortable.css') }}">
<link rel="stylesheet" href="{{ auto_asset('vendor/backpack/crud/css/crud.css') }}">
<link rel="stylesheet" href="{{ auto_asset('vendor/backpack/crud/css/reorder.css') }}">
@endsection

@section('after_scripts')
<script src="{{ auto_asset('vendor/backpack/crud/js/crud.js') }}"></script>
<script src="{{ auto_asset('vendor/backpack/crud/js/reorder.js') }}"></script>
