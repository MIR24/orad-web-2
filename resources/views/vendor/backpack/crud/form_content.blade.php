...
@section('after_styles')
    <link rel="stylesheet" href="{{ auto_asset('vendor/backpack/crud/css/crud.css') }}">
    <link rel="stylesheet" href="{{ auto_asset('vendor/backpack/crud/css/form.css') }}">
    <link rel="stylesheet" href="{{ auto_asset('vendor/backpack/crud/css/'.$action.'.css') }}">
...
@section('after_scripts')
    <script src="{{ auto_asset('vendor/backpack/crud/js/crud.js') }}"></script>
    <script src="{{ auto_asset('vendor/backpack/crud/js/form.js') }}"></script>
    <script src="{{ auto_asset('vendor/backpack/crud/js/'.$action.'.js') }}"></script>
